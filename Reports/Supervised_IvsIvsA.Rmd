...
ClusterUMAP_plot(umap_smp_a, color_by_cluster = T, color_by_protein = F, pallete = F,
                 cluster_col = 'n_op2', plot_clusnames = F, plot_title = 'Behavior class',
                 plot_colors = nop2, lg_names = c('aggressive'),  x_lim = c(-11,11), y_lim = c(-11,11))
```

## 1.2 Barplots of subtypes clusters
Epithelial cancer cells
```{r, echo=FALSE}
main_bp(annot_df, cond_col='n_op2', celltype_col='subtype_B', cluster_col='clusters_B', celltype_nm='Epithelial', ptID_col = 'pt_ID', celltype_nm_plot = "Epithelial cancer cells", plotly_p = T)
```
Endothelial cells
```{r, echo=FALSE}
main_bp(annot_df, cond_col='n_op2', celltype_col='subtype_B', cluster_col='clusters_B', celltype_nm='Endothelial', ptID_col = 'pt_ID', celltype_nm_plot = "Endothelial", plotly_p = T)
```
Fibroblasts/Mesenchymal cells
```{r, echo=FALSE}
main_bp(annot_df, cond_col='n_op2', celltype_col='subtype_B', cluster_col='clusters_B', celltype_nm='Fib_Mesenchymal', ptID_col = 'pt_ID', celltype_nm_plot = "Fibroblasts/Mesenchymal cells", plotly_p = T)
```
CD4+ T cells
```{r, echo=FALSE}
main_bp(annot_df, cond_col='n_op2', celltype_col='subtype_B', cluster_col='clusters_B', celltype_nm='Th_cells', ptID_col = 'pt_ID', celltype_nm_plot = "CD4+ T cells", plotly_p = T)
```
CD8+ T cells
```{r, echo=FALSE}
main_bp(annot_df, cond_col='n_op2', celltype_col='subtype_B', cluster_col='clusters_B', celltype_nm='Tc_cells', ptID_col = 'pt_ID', celltype_nm_plot = "CD8+ T cells", plotly_p = T)
```
DN T cells
```{r, echo=FALSE}
main_bp(annot_df, cond_col='n_op2', celltype_col='subtype_B', cluster_col='clusters_B', celltype_nm='DNT_cells', ptID_col = 'pt_ID', celltype_nm_plot = "DN T cells", plotly_p = T)
```
Myeloid cells
```{r, echo=FALSE}
main_bp(annot_df, cond_col='n_op2', celltype_col='subtype_B', cluster_col='clusters_B', celltype_nm='Myeloid', ptID_col = 'pt_ID', celltype_nm_plot = "Myeloid cells", plotly_p = T)
```
NK cells
```{r, echo=FALSE}
main_bp(annot_df, cond_col='n_op2', celltype_col='subtype_B', cluster_col='clusters_B', celltype_nm='NK_cells', ptID_col = 'pt_ID', celltype_nm_plot = "NK cells", plotly_p = T)
```
