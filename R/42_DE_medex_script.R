...
med_imm <- median_by_pt(annot_df, ref, subset_celltype=T, celltype_col='cell_type_B',
...
# Save RData
save(med_endo, med_epi, med_fibmes, med_imm, med_tcells, med_CD8T, med_CD4T, med_mye, 
