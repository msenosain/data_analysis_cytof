...
```{r, echo=FALSE}
tcga_adc <- read.table(file = '/Users/senosam/Documents/Massion_lab/RNA_seq/shilin\ TCGA/201908_tcgaDataDownload/GDCByTiger/LUAD.rnaseq2.fpkm.Primary_Solid_Tumor.tsv', sep = '\t', header = TRUE)
